...
{
    public abstract class CreatureStatsSO : GuidScriptableObject, IResettable  // IResettable 인터페이스 구현
    {
        // CreatureData 공통 필드들
        [Header("기본 식별자")]
        ...
        public virtual void Reset()
        {
            ...
            Debug.Log($"[CreatureStatsSO] {name} 초기화 완료");
        }

        public static implicit operator CreatureStatsSO(CreatureStat v)
        {
